function [y, est, data] = BSS_tabcd(x, action, Fs, ICAmet, subBands, simil, clust, weiTyp, fiLen, xName);
y = 0;
est = 0;
data.x=x;
data.fs = Fs;
...
%       h = waitbar(0,'Please wait...');
      ...
      if data.nsubbands==1
          [data.shat data.microphones We]=BBS_deconv(data.x,data.filterlength-1,param);
